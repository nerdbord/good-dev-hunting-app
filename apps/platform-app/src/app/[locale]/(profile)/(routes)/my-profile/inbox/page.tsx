...
import { JobNegotiation, Message } from './types'
        ...
        messages: [
            {
                id: '1',
                sender: 'company',
                content: 'Hi there! We\'ve reviewed your application and we\'re impressed with your skills.',
...
export default function InboxPage() {
    ...
    const [negotiations, setNegotiations] = useState<JobNegotiation[]>(mockNegotiations)
    const [selectedNegotiation, setSelectedNegotiation] = useState<JobNegotiation | null>(mockNegotiations[0])
    ...
    const handleSendMessage = (messageText: string) => {
        ...
        const updatedNegotiations = negotiations.map(negotiation =>
            negotiation.id === selectedNegotiation.id ? updatedNegotiation : negotiation
        )
